      ...
      <section className="relative border-b border-border/40" style={{ backgroundColor: "#0a1628" }}>
        ...
        <div className="mx-auto grid max-w-[1400px] grid-cols-[1.2fr_1fr] items-stretch gap-6 px-6 py-12 md:px-8 md:py-20">
          <div className="relative z-10 flex flex-col justify-center">
            ...
            <p className="mt-3 text-center font-display text-xl font-bold italic leading-[1.1] text-gold sm:text-2xl md:mt-4 md:whitespace-nowrap md:text-5xl">
            ...
            <h2 className="mt-6 text-center font-display text-2xl font-semibold italic leading-[1.1] text-gold sm:text-3xl md:mt-10 md:text-6xl">
