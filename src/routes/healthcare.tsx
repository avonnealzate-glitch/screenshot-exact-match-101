...
export const Route = createFileRoute("/healthcare")({
  head: () => ({ meta: [{ title: "Health Career Schools AI — Riley | Get Day AI" }, { name: "description", content: "Riley answers every inquiry for your healthcare career school 24/7 and fills your enrollment calendar." }] }),
  component: () => (
    <VerticalPage
      agent="Riley"
      vertical="Health Career Schools AI"
      hearLabel="Hear Riley Work"
      phoneDisplay="+1 (470) 243-2433"
      phoneHref="tel:+14702432433"
      description="Riley answers every inquiry for your healthcare career school 24/7. Qualifies students by program, availability, and readiness — and fills your enrollment calendar around the clock."
      bullets={[
